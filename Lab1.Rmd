...
-   It's difficult to see any trends with the way it's plotting raw data and not summary stats.
...
The package is most highly correlated with the price. This might be the most highly correlated because the different packages have different prices, price dependent on number of pumpkins; therefore, they are highly correlated.
...
The linear regression doesn't look representative of the spread of the data.
